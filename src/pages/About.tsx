export default function About() {
  return (
    <div className="max-w-3xl space-y-8">
      <div>
        <h1 className="text-2xl font-bold text-gray-900">About Police Stats NZ</h1>
        <p className="text-gray-600 mt-1">Transparency, methodology, and data sources</p>
      </div>
      ...
      <section className="bg-white rounded-lg shadow p-6">
        ...
        <div className="text-gray-700 space-y-2">
          <p>✅ <strong>No cookies</strong> — this site does not use cookies of any kind.</p>
          <p>✅ <strong>No tracking</strong> — no analytics, no Google Analytics, no user tracking whatsoever.</p>
          <p>✅ <strong>No user data collected</strong> — we collect absolutely no personal information.</p>
          <p>✅ <strong>Static site</strong> — all data is pre-compiled. No server-side processing of your requests.</p>
        </div>
      </section>
      ...
      <section className="bg-white rounded-lg shadow p-6">
        ...
        <a href="https://github.com/ryanmichaeljames/police-stats-nz" className="text-blue-600 underline mt-2 block" target="_blank" rel="noopener noreferrer">https://github.com/ryanmichaeljames/police-stats-nz</a>
      </section>

      <section className="bg-amber-50 border border-amber-200 rounded-lg p-6">
        <h2 className="text-xl font-semibold mb-3 text-amber-900">Disclaimer</h2>
